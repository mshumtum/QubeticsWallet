...
export default StyleSheet.create({
  ...
  physicalCard: { flex: 1, alignContent: 'flex-end', paddingHorizontal: 30 },
  physicalCardTxt: {
    alignSelf: 'flex-end',
    fontSize: 8,
    fontFamily: Fonts.dmSemiBold,
  ...
  cardNumber: { fontFamily: Fonts.dmRegular, fontSize: 25, marginTop: -2, alignSelf: 'center' },
  cardNumberStar: {
    fontFamily: Fonts.dmRegular,
    fontSize: 25,
    marginTop: 6,
  ...
  linkCardButton: { marginTop: 30, marginBottom: 17 },
